...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
  ...
  echo '</div>
        ...
        <a href="userProfile.php" class = " nav-link text-light my-0 mx-2 p-3">' . $_SESSION['fname'] . ' ' . $_SESSION['lname'] . ' </a>
            <a href="logout.php" class="btn btn-outline-success m-2" >Logout</a>
        </div>
      </div>
    </nav>';
}
