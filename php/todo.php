...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['check'])) {
        ...
        $update = "UPDATE todo SET title='$title', completed= '$completed', completed_at= current_timestamp(), created_at='$created_at' ,  updated_at= '$updated_at' WHERE id='$uid'";
    ...
    if (isset($_POST['uncheck'])) {
        ...
        $update = "UPDATE todo SET title='$title', completed= '$completed', completed_at= '', created_at='$created_at' ,  updated_at= '$updated_at' WHERE id='$uid'";
        if (!mysqli_query($conn, $update)) {
            $error = "Something Went Wrong!!";
            echo '<script>location.href="todo.php"</script>';
        } else {
                    ...
                    <div class="card-body">
                        <form action="todo.php" method="post">
                            <div class="input-group bg-dark">
                                <input type="text" placeholder="Write Your Task.." class="form-control" name="todo_input">
                                <div class="m-auto d-block">
                                    <button type="submit" class="btn btn-dark " name="add"><i class="fa-solid fa-calendar-plus"></i></button>
                                </div>
                            </div>
                            <div>
                    ...
                    <div class="container justify-content-center">
                        <nav id="tab">
                            <div class="m-auto nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link m-auto active" id="nav-up-tab" data-bs-toggle="tab" data-bs-target="#nav-up" type="button" role="tab" aria-controls="nav-up" aria-selected="false">Upcoming Tasks</button>
                                <button class="nav-link m-auto" id="nav-cm-tab" data-bs-toggle="tab" data-bs-target="#nav-cm" type="button" role="tab" aria-controls="nav-cm" aria-selected="false">Completed Tasks</button>
                            </div>
                        </nav>
                    </div>
                                                ...
                                                <div>
                                                    <form action="todo.php" method="post">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <input type="hidden" name="updated_at" value="<?php echo $data['updated_at']; ?>">
                                                        </td>
                                                        <td class="text-center"><?php echo $created_at ?>
                                                        </td>
                                                        <td class="text-center"><?php echo $updated_at ?>
                                                        </td>
                                                    </form>
                                                </div>
                                            <?php
                                    ...
                                    ?>
                                            <div>
                                                <form action="todo.php" method="post">
                                                    ...
                                                    <td class="text-center"><?php echo $completed_at; ?>
                                                    </td>
                                                </form>
                                            </div>
                                    <?php
