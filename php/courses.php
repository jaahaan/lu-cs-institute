    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://source.unsplash.com/2400x600/?code,coding," class="d-block w-100" height="200px" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2400x600/?code,programmer" class="d-block w-100" height="200px" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2400x600/?code,mycrosoft" class="d-block w-100" height="200px" alt="...">
            </div>
        </div>
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    echo '<div class="col-md-6 col-lg-4 my-2 justify-content-center">
                            <div class="card bg-dark text-light">
                                <img src="https://source.unsplash.com/500x400/?'.$title.',programming" class="card-img-top" alt="..." style="height: 16rem;">
                                <div class="card-body">
